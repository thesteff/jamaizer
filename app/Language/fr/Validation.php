...
return [
	...
	'is_unique'             => 'Ce/cette {field} est déjà pris.',
	...
	'matches'               => 'Le/la {field} ne correspond pas au/à la {param}.',
	'max_length'            => 'Le/la {field} ne doit pas dépasser {param} caractères de long.',
	// 'min_length'            => 'The {field} field must be at least {param} characters in length.',
	// 'not_equals'            => 'The {field} field cannot be: {param}.',
	'not_in_list'           => 'Le/la {field} doit faire partie de ces choix : {param}.',
	// 'numeric'               => 'The {field} field must contain only numbers.',
	// 'regex_match'           => 'The {field} field is not in the correct format.',
	'required'              => 'Le/la {field} est nécessaire.',
